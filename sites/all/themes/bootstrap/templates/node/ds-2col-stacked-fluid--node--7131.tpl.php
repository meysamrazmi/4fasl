  ...
  (function ($) {
    ...
    Drupal.behaviors.myregister = {attach: function (context, settings) {
        ...
        $('.attribute-3 > .form-item-attributes-3').append('<div class="description rules"><div>' +
          '<p>هزینه پرداختی، برای چهارجلسه (هر هفته یک جلسه) در نظر گرفته شده است.</p>' +
          '<p>در مرحله بعد (انتخاب استاد) میتوانید از رزومه و برنامه زمانی اساتید مطلع شوید.</p>' +
          '<p>پس از تکمیل ثبت نام، روز و ساعت آموزش برای شما اختصاص داده میشود و شما هر هفته در همان زمان اعلام شده از کلاس آموزشی استفاده می کنید.</p>' +
          '<p>پس از ثبت نام، از طرف آموزشگاه جهت برگزاری کلاس (از طریق نرم افزارها و اپلیکیشن های مورد نظر) با شما هماهنگ خواهد شد.</p>' +
          '<p>در صورت نیاز، اساتید علاوه بر برگزاری کلاس آنلاین، برای شما ویدیو آموزشی نیز به جهت درک بهتر مطالب آموزشی ارسال می کنند.</p>' +
