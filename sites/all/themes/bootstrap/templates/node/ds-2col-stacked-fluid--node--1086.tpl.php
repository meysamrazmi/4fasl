...
$('.attribute-3 > .form-item-attributes-3').append('<div class="description rules"><div><p>پس از ثبت نام، 3 جلسه اول آموزش به پروفایل شما ارسال میشود</p><p>اعتبار: با ثبت نام در دوره ی آموزشی، 85 هزار تومان به شما اعتبار داده میشود. برای ارسال تمرینات "به جهت بررسی توسط استاد" از این اعتبار میتوانید استفاده کنید.</p><p>اعتبار هدیه در نظر گرفته شده برای هنرجویان جدید پس از بررسی ثبت نام به حساب کاربری ایشان افزوده خواهد شد.</p><p>ارسال هر تمرین و بررسی آن توسط استاد، نیازمند استفاده از اعتبار از ۳۵۰۰۰ تومان تا ۴۵۰۰۰ تومان است. بعلاوه امتیازات تشویقی نیز باعث افزایش اعتبار شما خواهد شد</p><p>اساتید یک روز در هفته (که به اطلاع هنرجویان رسانده میشود) به بررسی تمرینات هنرجویان میپردازند.</p><p>ارسال تمرین، محدودیت زمانی ندارد، اما با ارسال هفتگی تمارین، امتیازات تشویقی به شما تعلق میگیرد.</p><p>به جهت درک بهتر مطالب، ویدیوهای آموزشی Full HD برای هنرجویان تهیه و تدوین شده است. این ویدیوها با توجه به صلاحدید اساتید برای هنرجویان ارسال میشود.</p><p>ویدیوهای آموزشی که برای هنرجویان ارسال میشود رایگان بوده و نیازمند پرداخت هزینه های اضافی نیست.</p><p>برای آشنایی بیشتر می توانید <a href="/faq" class="btn" target="_blank">سوالات متداول</a> و <a href="/node/66" class="btn" target="_blank">نحوه ی کار</a> را مشاهده کنید.</p></div><div class="title"><img src="/sites/all/themes/bootstrap/images/law-book.svg"><span>شرایط و قوانین ثبت نام</span></div></div>');
