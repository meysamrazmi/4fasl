...
$('.attribute-3 > .form-item-attributes-3').append('<div class="description rules"><div><p>اعتبار: با ثبت نام در دوره ی آموزشی، 120 هزار تومان به شما اعتبار داده میشود. برای ارسال تمرینات "به جهت بررسی توسط استاد" از این اعتبار میتوانید استفاده کنید.</p>' +
    '<p>با ارسال هر تمرین به جهت بررسی استاد و تایید برای دریافت درس جدید، ۵۵هزار تومان از اعتبار شما کسر میشود. با ارسال هفتگی تمارین، ۱۰ هزار تومان تخفیف شامل حال شما میشود.</p>' +
