...
<div class="teacher-rating field" <?php print $attributes; ?>>
  <?php if (!$label_hidden): ?>
    <div class="field-label"<?php print $title_attributes; ?>><?php print $label ?></div>
  <?php endif; ?>
  <div class="desc">تا چه اندازه از پاسخ استاد و زمانی که برای شما گذاشته است راضی بوده اید؟</div>
  <div class="rating" <?php print $content_attributes; ?>>
...
.teacher-rating div.fivestar-widget {
